  ...
  function showResidenceOrientation(existingJourney = null) {
    ...
    const renderResult = (routeId) => {
      ...
      screen.innerHTML =
        ...
        '<div style="display:flex;gap:10px;flex-wrap:wrap;margin-top:18px"><button class="outline" id="orientation-back" type="button" style="min-width:176px;min-height:48px;margin-top:0;display:inline-flex;align-items:center;justify-content:center;box-sizing:border-box">← Retour</button><button class="primary" id="orientation-continue" type="button" style="min-width:176px;min-height:48px;margin-top:0;display:inline-flex;align-items:center;justify-content:center;box-sizing:border-box">' + (existingJourney ? 'Mettre à jour ce dossier' : 'Préparer cette checklist') + ' <span>→</span></button><button class="outline" id="orientation-choose" type="button">' + (existingJourney ? 'Choisir une autre situation' : 'Choisir ma situation moi-même') + '</button></div>' +
        disclaimer;
    ...
    const renderUncertain = () => {
      screen.innerHTML =
        ...
        '<div style="display:flex;gap:10px;flex-wrap:wrap;margin-top:18px"><button class="outline" id="orientation-back" type="button" style="min-width:176px;min-height:48px;margin-top:0;display:inline-flex;align-items:center;justify-content:center;box-sizing:border-box">← Retour</button><button class="primary" id="orientation-choose" type="button">Choisir ma situation <span>→</span></button></div>' +
        disclaimer;
      screen.querySelector('#orientation-back').addEventListener('click', goBack);
      screen.querySelector('#orientation-choose').addEventListener('click', choose);
    };
